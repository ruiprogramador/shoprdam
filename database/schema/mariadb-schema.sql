...
CREATE TABLE `inventories` (
  ...
  `on_hand_quantity` bigint(20) NOT NULL,
...
CREATE TABLE `inventory_reservations` (
  ...
  CONSTRAINT `inventory_reservations_inventory_id_foreign` FOREIGN KEY (`inventory_id`) REFERENCES `inventories` (`id`),
  CONSTRAINT `inventory_reservations_order_item_id_foreign` FOREIGN KEY (`order_item_id`) REFERENCES `order_items` (`id`),
  CONSTRAINT `inventory_reservations_quantity_positive` CHECK (`quantity` >= 1),
  CONSTRAINT `inventory_reservations_status_evidence` CHECK (`status` = 'reserved' and `committed_at` is null and `released_at` is null or `status` = 'committed' and `committed_at` is not null and `released_at` is null or `status` = 'released' and `released_at` is not null and `committed_at` is null)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `kyc_documents` (
  ...
  `document_side_id` bigint(20) unsigned DEFAULT NULL,
  ...
  CONSTRAINT `kyc_documents_document_type_id_foreign` FOREIGN KEY (`document_type_id`) REFERENCES `document_types` (`id`),
...
CREATE TABLE `kyc_history` (
  ...
  CONSTRAINT `kyc_history_to_status_id_foreign` FOREIGN KEY (`to_status_id`) REFERENCES `kyc_status` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `kycs` (
  ...
  `kyc_status_id` bigint(20) unsigned NOT NULL,
  `reviewed_by` bigint(20) unsigned DEFAULT NULL,
  `country_id` bigint(20) unsigned NOT NULL,
  `state_id` bigint(20) unsigned NOT NULL,
  ...
  CONSTRAINT `kycs_city_id_foreign` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`),
  CONSTRAINT `kycs_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`),
  CONSTRAINT `kycs_gender_id_foreign` FOREIGN KEY (`gender_id`) REFERENCES `genders` (`id`),
  CONSTRAINT `kycs_kyc_status_id_foreign` FOREIGN KEY (`kyc_status_id`) REFERENCES `kyc_status` (`id`),
  CONSTRAINT `kycs_reviewed_by_foreign` FOREIGN KEY (`reviewed_by`) REFERENCES `admins` (`id`) ON DELETE SET NULL,
  CONSTRAINT `kycs_state_id_foreign` FOREIGN KEY (`state_id`) REFERENCES `states` (`id`),
...
CREATE TABLE `order_items` (
  ...
  CONSTRAINT `order_items_currency_id_foreign` FOREIGN KEY (`currency_id`) REFERENCES `currencies` (`id`),
...
CREATE TABLE `payment_attempts` (
  ...
  `recovery_attempts` int(10) unsigned NOT NULL DEFAULT 0,
  `last_attempted_at` timestamp NULL DEFAULT NULL,
  `last_recovery_error` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `payment_provider_events` (
  ...
  `status` varchar(20) NOT NULL DEFAULT 'pending',
  `replay_attempts` int(10) unsigned NOT NULL DEFAULT 0,
  `last_replay_error` text DEFAULT NULL,
...
CREATE TABLE `payment_reconciliation_findings` (
  ...
  `provider` varchar(40) NOT NULL,
  `provider_reference` varchar(255) NOT NULL,
  `active_identity` varchar(255) DEFAULT NULL,
  `category` varchar(48) NOT NULL,
  `severity` varchar(20) NOT NULL,
  `local_state` varchar(40) DEFAULT NULL,
  `remote_state` varchar(40) DEFAULT NULL,
  `local_amount_minor_units` bigint(20) unsigned DEFAULT NULL,
  `remote_amount_minor_units` bigint(20) unsigned DEFAULT NULL,
  `local_currency` varchar(3) DEFAULT NULL,
  `remote_currency` varchar(3) DEFAULT NULL,
  `local_correlation_id` varchar(255) DEFAULT NULL,
  `remote_correlation_id` varchar(255) DEFAULT NULL,
  `status` varchar(20) NOT NULL,
  `first_observed_at` timestamp NOT NULL,
  `last_observed_at` timestamp NOT NULL,
  `observation_count` int(10) unsigned NOT NULL DEFAULT 1,
  `resolved_at` timestamp NULL DEFAULT NULL,
  `resolution_reason` varchar(40) DEFAULT NULL,
  ...
  CONSTRAINT `payment_reconciliation_findings_payment_attempt_id_foreign` FOREIGN KEY (`payment_attempt_id`) REFERENCES `payment_attempts` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment_recovery_actions` (
  ...
  CONSTRAINT `payment_recovery_actions_payment_attempt_id_foreign` FOREIGN KEY (`payment_attempt_id`) REFERENCES `payment_attempts` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payments` (
  ...
  `order_id` bigint(20) unsigned NOT NULL,
  `status` varchar(20) NOT NULL DEFAULT 'pending',
  `current_payment_attempt_id` bigint(20) unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `payout_attempts` (
  ...
  `provider` varchar(40) NOT NULL,
  `provider_reference` varchar(255) DEFAULT NULL,
  `external_transfer_reference` varchar(255) DEFAULT NULL,
  `idempotency_key` varchar(255) NOT NULL,
  `status` varchar(20) NOT NULL DEFAULT 'pending',
  `locked_until` timestamp NULL DEFAULT NULL,
  `recovery_attempts` int(10) unsigned NOT NULL DEFAULT 0,
  ...
  CONSTRAINT `payout_attempts_payout_id_foreign` FOREIGN KEY (`payout_id`) REFERENCES `payouts` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payout_recovery_actions` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `payout_attempt_id` bigint(20) unsigned NOT NULL,
  `admin_id` bigint(20) unsigned DEFAULT NULL,
  `action` varchar(40) NOT NULL,
  `outcome` varchar(40) NOT NULL,
  `detail` text DEFAULT NULL,
  ...
  CONSTRAINT `payout_recovery_actions_payout_attempt_id_foreign` FOREIGN KEY (`payout_attempt_id`) REFERENCES `payout_attempts` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payouts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `store_id` bigint(20) unsigned NOT NULL,
  `store_wallet_id` bigint(20) unsigned NOT NULL,
  `amount` decimal(18,2) NOT NULL,
  `currency_id` bigint(20) unsigned NOT NULL,
  `idempotency_key` varchar(255) NOT NULL,
  `status` varchar(20) NOT NULL DEFAULT 'reserved',
  `current_payout_attempt_id` bigint(20) unsigned DEFAULT NULL,
  `debit_transaction_id` bigint(20) unsigned DEFAULT NULL,
  ...
  CONSTRAINT `payouts_currency_id_foreign` FOREIGN KEY (`currency_id`) REFERENCES `currencies` (`id`),
  CONSTRAINT `payouts_current_payout_attempt_id_foreign` FOREIGN KEY (`current_payout_attempt_id`) REFERENCES `payout_attempts` (`id`),
  CONSTRAINT `payouts_debit_transaction_id_foreign` FOREIGN KEY (`debit_transaction_id`) REFERENCES `store_wallet_transactions` (`id`),
  CONSTRAINT `payouts_requested_by_foreign` FOREIGN KEY (`requested_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `payouts_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`),
  CONSTRAINT `payouts_store_wallet_id_foreign` FOREIGN KEY (`store_wallet_id`) REFERENCES `store_wallets` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `store_wallet_transactions` (
  ...
  `metadata` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Additional provider-specific information' CHECK (json_valid(`metadata`)),
  ...
  CONSTRAINT `store_wallet_transactions_store_wallet_id_foreign` FOREIGN KEY (`store_wallet_id`) REFERENCES `store_wallets` (`id`),
  CONSTRAINT `store_wallet_transactions_transaction_category_id_foreign` FOREIGN KEY (`transaction_category_id`) REFERENCES `transaction_categories` (`id`),
  CONSTRAINT `store_wallet_transactions_transaction_status_id_foreign` FOREIGN KEY (`transaction_status_id`) REFERENCES `transaction_statuses` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `store_wallets` (
  ...
  CONSTRAINT `store_wallets_currency_id_foreign` FOREIGN KEY (`currency_id`) REFERENCES `currencies` (`id`),
  CONSTRAINT `store_wallets_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stores` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) unsigned NOT NULL,
  `store_status_id` bigint(20) unsigned NOT NULL,
  `slug` varchar(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  ...
  CONSTRAINT `stores_store_status_id_foreign` FOREIGN KEY (`store_status_id`) REFERENCES `store_statuses` (`id`),
...
CREATE TABLE `translation_values` (
  ...
  `value_short` varchar(255) DEFAULT NULL,
  `value` text DEFAULT NULL,
  `value_long` longtext DEFAULT NULL,
  `value_html` longtext DEFAULT NULL,
  `status` enum('missing','auto','done') NOT NULL DEFAULT 'missing',
...
/*M!999999\- enable the sandbox mode */ 
SET @OLD_AUTOCOMMIT=@@AUTOCOMMIT, @@AUTOCOMMIT=0;
INSERT INTO `user_types` (`id`, `name`, `created_at`, `updated_at`) VALUES (1,'User','2026-09-22 17:07:15','2026-09-22 17:07:15');
INSERT INTO `user_types` (`id`, `name`, `created_at`, `updated_at`) VALUES (2,'Vendor','2026-09-22 17:07:15','2026-09-22 17:07:15');
COMMIT;
SET AUTOCOMMIT=@OLD_AUTOCOMMIT;
